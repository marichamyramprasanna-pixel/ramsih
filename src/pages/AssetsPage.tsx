...
export const AssetsPage: React.FC<AssetsPageProps> = ({
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto relative overflow-hidden">
      ...
      <div className="absolute top-10 left-1/4 w-96 h-96 bg-cyan-600/10 rounded-full blur-3xl bg-orb-cyan pointer-events-none" />
      <div className="absolute bottom-1/3 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl bg-orb-blue pointer-events-none" />
