...
export const SettingsPage: React.FC<SettingsPageProps> = ({
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-[1200px] mx-auto relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl bg-orb-blue pointer-events-none" />
      {/* Header */}
      <div>
