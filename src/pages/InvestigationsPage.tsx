...
export const InvestigationsPage: React.FC<InvestigationsPageProps> = ({
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-[1700px] mx-auto relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl bg-orb-blue pointer-events-none" />
