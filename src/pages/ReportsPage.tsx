...
export const ReportsPage: React.FC<ReportsPageProps> = ({
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto print:p-0 relative overflow-hidden">
      {/* Background Floating Ambient Glowing Orbs */}
      <div className="absolute top-10 left-10 w-96 h-96 bg-cyan-600/10 rounded-full blur-3xl bg-orb-cyan pointer-events-none print:hidden" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl bg-orb-blue pointer-events-none print:hidden" />
      {/* Toast Notification */}
      {toastMsg && (
